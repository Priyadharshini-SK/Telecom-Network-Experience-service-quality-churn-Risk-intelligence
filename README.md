...
Customer demographics (gender, senior citizen, partner status)
Average tenure and monthly charges
Internet service usage and payment preferences

3️⃣ Customer Segment Risk Analysis

Churn rate by contract type
Churn trends across customer tenure
Risk comparison by internet service and payment method
...
Lack of Tech Support and Online Security significantly increases churn probability
Customers using Electronic Check payment method show higher churn rates
